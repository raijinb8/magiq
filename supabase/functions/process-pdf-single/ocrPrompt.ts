...
対象会社一覧：
1. NOHARA_G_MISAWA（野原G住環境_ミサワホーム）
   - 確定キーワード：「野原グループ株式会社」→ 必ずNOHARA_G_MISAWA
...
判定ルール（優先順位順）：
1. 「野原グループ株式会社」が含まれている → 必ずNOHARA_G_MISAWA（信頼度0.95以上）
...
- 手配書の内容は解析しません
- 会社名の特定のみに集中してください
- 「野原グループ株式会社」が検出された場合は、他のキーワードに関係なく必ずNOHARA_G_MISAWAとして判定
